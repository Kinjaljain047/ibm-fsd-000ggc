...
public class ListEmployee extends HttpServlet {
	...
	protected void doProcess(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, SQLException {
		...
		for(Employee e : emplist) {
			out.println("<tr><td>" +e.getId()+"</td><td>"+e.getName()+"</td><td>"+e.getEmail()+"</td><td>"+e.getPassword()+"</td><td>"+e.getCountry()+"</td><td>"+"<a href=\"delete_employee?id="+e.getId()+"\"><button type='button'>Delete</button></a>"+"</td><td>"+"<a href=\"edit_view?id="+e.getId()+"\"<button type='button'>Edit</button>"+"</td></tr>");
		}
