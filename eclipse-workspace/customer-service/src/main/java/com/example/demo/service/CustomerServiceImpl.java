	...
	public CustomerDto createCustomer(CustomerDto customer) {
			...
			CustomerDto cust = mapper.map(c, CustomerDto.class);
				...
				SimpleMailMessage helper= new SimpleMailMessage();
				 ...
				 helper.setText("Congratulations,You are our customer now!! We are so happy that now you are a part of our family and we promise to keep u provide best services. ThankYou :)");
